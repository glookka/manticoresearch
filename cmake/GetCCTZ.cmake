...
if ( BUILD_TESTING )
	set ( _stored_BUILD_TESTING ON )
endif()

if ( BUILD_EXAMPLES )
	set ( _stored_BUILD_EXAMPLES ON )
endif()

if ( BUILD_TOOLS )
	set ( _stored_BUILD_TOOLS ON )
endif()
...
if ( _stored_BUILD_TESTING )
	set ( BUILD_TESTING ON CACHE BOOL "" FORCE )
endif()

if ( _stored_BUILD_EXAMPLES )
	set ( BUILD_EXAMPLES ON CACHE BOOL "" FORCE )
endif()

if ( _stored_BUILD_TOOLS )
